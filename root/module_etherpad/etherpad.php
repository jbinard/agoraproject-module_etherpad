...
echo "<script type=\"text/javascript\">
    ...
    jQuery(document).ready(function() {
        jQuery('#ePad').pad({'host': '{$etherpad_url}', 'padId':'{$etherpad_tmp["id_serveur"]}', 'baseUrl': '/p/', 'showChat': true, 'userName': '{$_SESSION["user"]["prenom"]} {$_SESSION["user"]["nom"]}','showControls': true,'showLineNumbers': true, 'height': 600});
    });
    </script>";
?>
